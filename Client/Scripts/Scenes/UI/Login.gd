...
onready var email_field: LineEdit = get_node("CanvasLayer/VBoxContainer/GridContainer/LineEdit_Email")
...
signal register(username, password, email)
...
func _register():
	emit_signal("register", username_field.text, password_field.text, email_field.text, avatar_id)
